...
This file tracks the current features, tasks, and future implementations.

## Phase 1: Setup & Initialization
- [x] Configure strictly open-source workflow
...
- Version stays at **0.0.1** until core features are finalized.
