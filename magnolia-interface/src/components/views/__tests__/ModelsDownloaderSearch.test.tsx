...
describe('ModelsDownloader - Search Models', () => {
  ...
  it('shows search results when model search succeeds', async () => {
  ...
  it('shows empty state when model search fails', async () => {
    ...
    // Wait for search to complete and render the empty state
    await waitFor(() => {
